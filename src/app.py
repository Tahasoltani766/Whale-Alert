...
data = {'address': '0x3416cF6C708Da44DB2624D63ea0AAef7113527C6',
        'blocks': [{'block': 19681142, 'balance': -81555822883}, {'block': 19681143, 'balance': -235863245632},
                   {'block': 19681145, 'balance': 28293460715}, {'block': 19681146, 'balance': 0}]}
address = w3.to_checksum_address(data['address'])
blocks = [entry['block'] for entry in data['blocks']]
balances = [entry['balance'] for entry in data['blocks']]
weth_contract = w3.eth.contract(address=adr_token, abi=abi_token)
print(balances)
blnc = weth_contract.functions.balanceOf(address).call(block_identifier=blocks[0] - 1)
balances[0] = blnc
